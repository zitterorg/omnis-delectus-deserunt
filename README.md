# @zitterorg/omnis-delectus-deserunt

Get details about the current Continuous Integration environment.

Please [open an
issue](https://github.com/zitterorg/omnis-delectus-deserunt/issues/new?template=ci-server-not-detected.md)
if your CI server isn't properly detected :)

[![npm](https://img.shields.io/npm/v/@zitterorg/omnis-delectus-deserunt.svg)](https://www.npmjs.com/package/@zitterorg/omnis-delectus-deserunt)
[![Tests](https://github.com/zitterorg/omnis-delectus-deserunt/workflows/Tests/badge.svg)](https://github.com/zitterorg/omnis-delectus-deserunt/actions)
[![js-standard-style](https://img.shields.io/badge/code%20style-standard-brightgreen.svg?style=flat)](https://github.com/feross/standard)

## Installation

```bash
npm install @zitterorg/omnis-delectus-deserunt --save
```

## Usage

```js
var ci = require('@zitterorg/omnis-delectus-deserunt')
...
@zitterorg/omnis-delectus-deserunt has been ported to the following languages

| Language | Repository |
|----------|------------|
| Go       | https://github.com/hofstadter-io/cinful |
| Rust     | https://github.com/sagiegurari/ci_info |
| Kotlin   | https://github.com/cloudflightio/@zitterorg/omnis-delectus-deserunt |
